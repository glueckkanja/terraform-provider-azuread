...
import (
	...
	administrativeunits "github.com/glueckkanja/terraform-provider-azuread/internal/services/administrativeunits/client"
	applications "github.com/glueckkanja/terraform-provider-azuread/internal/services/applications/client"
	approleassignments "github.com/glueckkanja/terraform-provider-azuread/internal/services/approleassignments/client"
	conditionalaccess "github.com/glueckkanja/terraform-provider-azuread/internal/services/conditionalaccess/client"
	directoryobjects "github.com/glueckkanja/terraform-provider-azuread/internal/services/directoryobjects/client"
	directoryroles "github.com/glueckkanja/terraform-provider-azuread/internal/services/directoryroles/client"
	domains "github.com/glueckkanja/terraform-provider-azuread/internal/services/domains/client"
	groups "github.com/glueckkanja/terraform-provider-azuread/internal/services/groups/client"
	identitygovernance "github.com/glueckkanja/terraform-provider-azuread/internal/services/identitygovernance/client"
	invitations "github.com/glueckkanja/terraform-provider-azuread/internal/services/invitations/client"
	policies "github.com/glueckkanja/terraform-provider-azuread/internal/services/policies/client"
	serviceprincipals "github.com/glueckkanja/terraform-provider-azuread/internal/services/serviceprincipals/client"
	synchronization "github.com/glueckkanja/terraform-provider-azuread/internal/services/synchronization/client"
	userflows "github.com/glueckkanja/terraform-provider-azuread/internal/services/userflows/client"
	users "github.com/glueckkanja/terraform-provider-azuread/internal/services/users/client"
)
